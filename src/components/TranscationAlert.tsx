...
interface CustomAlertTransactionProps {
    visible: boolean;
    title: string;
...
const CustomAlertTransaction: React.FC<CustomAlertTransactionProps> = ({
    visible,
    title,
    onClose,
    inputValueData,
    ...
    // Sync inputValue with inputValueData on prop change
    useEffect(() => {
            ...
            <View style={styles.overlay}>
                <View style={[styles.container, { backgroundColor: themeProperties.backgroundColor }]}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setInputValue(text.replace(/[^0-9]/g, ""))} // Numeric input only
                    />
...
export default CustomAlertTransaction;
